...
const translations = {
  en: {
    ...
    "capabilities.nav.title": "Quick Navigation",
    "capabilities.governance.title": "Open Source Governance",
    "capabilities.governance.desc":
      "Establish policies, processes, and guidelines for open source usage and contribution",
    "capabilities.education.title": "Developer Education",
    "capabilities.education.desc": "Provide training and resources for developers on open source best practices",
    "capabilities.contribution.title": "Contribution Strategy",
    "capabilities.contribution.desc": "Strategic approach to contributing to external open source projects",
    "capabilities.innersource.title": "Inner Source Program",
    "capabilities.innersource.desc": "Apply open source principles to internal development",
    "capabilities.security.title": "Security & Compliance",
    "capabilities.security.desc": "Ensure security and legal compliance in open source usage",
    "capabilities.milestones": "Milestones",
    "capabilities.status.completed": "Completed",
    "capabilities.status.inProgress": "In Progress",
    "capabilities.status.planned": "Planned",
    "capabilities.milestone.policyFramework": "Policy Framework",
    "capabilities.milestone.governanceCommittee": "Governance Committee",
    "capabilities.milestone.complianceTooling": "Compliance Tooling",
    "capabilities.milestone.auditProcess": "Audit Process",
    "capabilities.milestone.basicTraining": "Basic Training",
    "capabilities.milestone.advancedWorkshops": "Advanced Workshops",
    "capabilities.milestone.certificationProgram": "Certification Program",
    "capabilities.milestone.mentorshipProgram": "Mentorship Program",
    "capabilities.milestone.contributionGuidelines": "Contribution Guidelines",
    "capabilities.milestone.projectSelectionFramework": "Project Selection Framework",
    "capabilities.milestone.contributionMetrics": "Contribution Metrics",
    "capabilities.milestone.communityLeadership": "Community Leadership",
    "capabilities.milestone.innersourceGuidelines": "Inner Source Guidelines",
    "capabilities.milestone.pilotProjects": "Pilot Projects",
    "capabilities.milestone.toolingInfrastructure": "Tooling & Infrastructure",
    "capabilities.milestone.organizationRollout": "Organization Rollout",
    "capabilities.milestone.securityScanning": "Security Scanning",
    "capabilities.milestone.licenseCompliance": "License Compliance",
    "capabilities.milestone.vulnerabilityManagement": "Vulnerability Management",
    "capabilities.milestone.automatedCompliance": "Automated Compliance",
  ...
  zh: {
    ...
    "capabilities.nav.title": "快速导航",
    "capabilities.governance.title": "开源治理",
    "capabilities.governance.desc": "建立开源使用和贡献的政策、流程和指南",
    "capabilities.education.title": "开发者教育",
    "capabilities.education.desc": "为开发者提供开源最佳实践的培训和资源",
    "capabilities.contribution.title": "贡献策略",
    "capabilities.contribution.desc": "对外部开源项目贡献的战略方法",
    "capabilities.innersource.title": "内源计划",
    "capabilities.innersource.desc": "将开源原则应用于内部开发",
    "capabilities.security.title": "安全与合规",
    "capabilities.security.desc": "确保开源使用中的安全性和法律合规",
    "capabilities.milestones": "里程碑",
    "capabilities.status.completed": "已完成",
    "capabilities.status.inProgress": "进行中",
    "capabilities.status.planned": "计划中",
    "capabilities.milestone.policyFramework": "政策框架",
    "capabilities.milestone.governanceCommittee": "治理委员会",
    "capabilities.milestone.complianceTooling": "合规工具",
    "capabilities.milestone.auditProcess": "审计流程",
    "capabilities.milestone.basicTraining": "基础培训",
    "capabilities.milestone.advancedWorkshops": "高级研讨会",
    "capabilities.milestone.certificationProgram": "认证计划",
    "capabilities.milestone.mentorshipProgram": "导师计划",
    "capabilities.milestone.contributionGuidelines": "贡献指南",
    "capabilities.milestone.projectSelectionFramework": "项目选择框架",
    "capabilities.milestone.contributionMetrics": "贡献指标",
    "capabilities.milestone.communityLeadership": "社区领导力",
    "capabilities.milestone.innersourceGuidelines": "内源指南",
    "capabilities.milestone.pilotProjects": "试点项目",
    "capabilities.milestone.toolingInfrastructure": "工具与基础设施",
    "capabilities.milestone.organizationRollout": "全组织推广",
    "capabilities.milestone.securityScanning": "安全扫描",
    "capabilities.milestone.licenseCompliance": "许可证合规",
    "capabilities.milestone.vulnerabilityManagement": "漏洞管理",
    "capabilities.milestone.automatedCompliance": "自动化合规",
